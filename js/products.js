...
<button class="relative group w-5/6 p-2 text-end bg-white text-[#19488f] text-sm border border-[#19488f] hover:bg-[#19488f] hover:text-white hover:border-transparent ">
